...
const I18N = {
  menu: {
    ...
    planCredits: {
      es: "créditos plan",
      en: "plan credits",
      pt: "créditos do plano",
      it: "crediti del piano",
      de: "Plan-Credits",
      fr: "crédits du forfait"
    },
    logout: {
      es: "Cerrar sesión",
      en: "Logout",
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className="p-2.5 hover:opacity-80 active:opacity-60 transition-opacity"
        aria-label="Menu"
        style={{ touchAction: 'manipulation', WebkitTapHighlightColor: 'transparent' }}
      >
        <MoreVertical className="w-6 h-6 text-white" style={{ filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.8)) drop-shadow(0 0 8px rgba(0,0,0,0.6))' }} />
      </button>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 text-gray-700">
                      ...
                      <span className="text-xs sm:text-sm font-semibold">
                        {creditsError ? '--' : `${currentCredits ?? 0}/${totalCredits ?? 0}`} {I18N.menu.planCredits[lang]}
                      </span>
                    </div>
